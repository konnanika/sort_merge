...
#define NUM_OF_LINES_IN_FILE_1						smarelA			// Number of lines in first file
#define NUM_OF_LINES_IN_FILE_2						smarelB			// Number of lines in second file
...
#define MAX_NUM_OF_RECORDS_IN_TEMP_SORTED_TABLE		smarelB			// Maximum size of temporary table
